...
3. Payment can be made through the PayPal link on the
   [registration page]({{ site.url }}{{ site.baseurl }}/registration/), or by
   check made out to JLMGT, Inc. and handed to a committee member during
   check-in.
